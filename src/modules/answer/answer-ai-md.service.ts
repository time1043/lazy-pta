...
export async function answerAiMd(dirPath: string, problemType: ProblemType) {
...
export async function questionAnswerAiMd(dirPath: string, problemType: ProblemType) {
